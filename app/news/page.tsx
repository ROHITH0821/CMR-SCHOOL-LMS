...
const posts = [
  {
    ...
    cat: "School News",
    date: "Mar 12, 2026",
    img: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?w=1200&q=80",
    featured: true,
  },
  {
    slug: "quiz-finals",
  ...
  {
    slug: "student-spotlight-ria",
    title: "Student spotlight: Ria’s robotics journey",
    excerpt: "From first LEGO kit to zonal championships.",
    cat: "Student Spotlight",
    date: "Jan 18, 2026",
    ...
    <div className="bg-[#FFFFFF]">
      <section className="container-custom pt-12 pb-16">
        ...
        >
          ...
          <h1 className="font-display text-5xl sm:text-7xl font-bold text-[#0A2463]">News & Blog</h1>
          <p className="mt-6 max-w-2xl text-gray-500 font-body text-lg leading-relaxed">
            Discover the latest breakthroughs, student achievements, and leadership reflections from the CMR legacy.
          </p>
        </motion.div>
      </section>
      ...
      <section className="pb-32">
        <div className="container-custom">
          ...
          >
            <Link href={`/news/${featured.slug}`} className="group block overflow-hidden rounded-[2.5rem] border border-gray-100 bg-white shadow-[0_30px_80px_rgba(0,0,0,0.05)]">
              <div className="grid gap-0 lg:grid-cols-2">
                ...
                <div className="flex flex-col justify-center p-8 lg:p-16">
                  ...
                  <p className="mt-6 text-gray-500 font-body text-lg leading-relaxed">{featured.excerpt}</p>
            ...
            {rest.map((p) => (
              <motion.article key={p.slug} variants={item} className="group flex flex-col cursor-pointer">
                ...
                <div className="pt-6 flex flex-col flex-1">
                  <span className="text-[#F5A623] font-bold tracking-widest text-[10px] uppercase mb-4">{p.cat}</span>
                  ...
                  <p className="mt-4 text-gray-500 text-[15px] leading-relaxed line-clamp-2 md:line-clamp-3 mb-6 flex-1">
                    {p.excerpt}
                  </p>
